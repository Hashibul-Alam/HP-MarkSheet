...
const ReportCard = () => {
  ...
  return (
    <div
    style={{border: "10px solid transparent", padding: "10px", backgroundImage: "url('http://www.transparenttextures.com/patterns/subtle-dots.png')"}}
    className="max-w-[555px] mx-auto p-6 mt-6 bg-amber-50/25 border-amber-50/25 shadow-lg rounded-lg border-4 relative">
      ...
      {students.map((student) => {
        ...
        return (
          <div key={student.id} className="mt-4 p-4 border border-gray-300 rounded-md">
  ...
  <div className="text-center">
    <p className="font-semibold mt-2">Eshan Ahmed</p>
    <p className="text-sm text-gray-600 border-t border-gray-400 mt-1 pt-1">
...
<div className="mt-8">
  <div className="text-center">
    <p className="font-semibold mt-2">Harun-Ur-Roshid</p>
    <p className="text-sm text-gray-600 border-t border-gray-400 mt-1 pt-1">
      Founder, Hablu Programmer
    </p>
  </div>
